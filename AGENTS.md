...
It is used to configure the node itself, including the hostname, host folders, host network interfaces, firewall ports, and the Podman containers that should be present.
